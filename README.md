...
* A simple polyhedral/RPG/wargame dice roller with predefined buttons for the common dice types (D4, D6, D8, D10, D12, D20), percentile (D100) and Fudge/FATE dice (DF), plus additional uncommon dice (D2, D3, D5, D7, D14, D16, D24, D30, D60, D120) which are initially hidden by default. 
...
* Options page allows selection of which dice are shown or hidden, so you can hide all the ones you don't use 
* Options to customize all dice definitions, so your D10 can be numbered 0-9 instead of 1-10, or edit any unusued definition into a custom die with a unique value range
